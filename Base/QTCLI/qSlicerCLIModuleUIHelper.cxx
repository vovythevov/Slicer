...
WIDGET_VALUE_WRAPPER(Point, qMRMLNodeComboBox, currentNodeId, setCurrentNodeId, String, currentNodeChanged(vtkMRMLNode*));
WIDGET_VALUE_WRAPPER(Region, qMRMLNodeComboBox, currentNodeId, setCurrentNodeId, String, currentNodeChanged(vtkMRMLNode*));
WIDGET_VALUE_WRAPPER(Image, qMRMLNodeComboBox, currentNodeId, setCurrentNodeId, String, currentNodeChanged(vtkMRMLNode*));
WIDGET_VALUE_WRAPPER(Geometry, qMRMLNodeComboBox, currentNodeId, setCurrentNodeId, String, currentNodeChanged(vtkMRMLNode*));
WIDGET_VALUE_WRAPPER(Table, qMRMLNodeComboBox, currentNodeId, setCurrentNodeId, String, currentNodeChanged(vtkMRMLNode*));
WIDGET_VALUE_WRAPPER(Transform, qMRMLNodeComboBox, currentNodeId, setCurrentNodeId, String, currentNodeChanged(vtkMRMLNode*));
...
WIDGET_VALUE_WRAPPER(Measurement, qMRMLNodeComboBox, currentNodeId, setCurrentNodeId, String, currentNodeChanged(vtkMRMLNode*));
