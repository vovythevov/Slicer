...
class SlicerRASBoundsTest(ScriptedLoadableModule):
...
class SlicerRASBoundsTestWidget(ScriptedLoadableModuleWidget):
  """
  """
  def setup(self):
...
class SlicerRASBoundsTestLogic(ScriptedLoadableModuleLogic):
  """
  """

class SlicerRASBoundsTestTest(ScriptedLoadableModuleTest):
  """
  """
  def setUp(self):
  ...
  def test_Volume(self):
    """ Test the GetRASBounds method on a volume.
    """
  ...
  def test_Model(self):
    """ Test the GetRASBounds method on a model.
    """
  ...
  def test_Segmentation(self):
    """ Test the GetRASBounds method on a segmentation.
    """
    #self.delayDisplay("Starting test_Segmentation")
    pass  # SEGMENTATION ARE UNSUPPORTED AT THE MOMMENT
    #self.delayDisplay('test_Segmentation passed!')

  def test_Markup(self):
    """ Test the GetRASBounds method on a markup.
    """
  ...
  def test_ROI(self):
    """ Test the GetRASBounds method on a ROI.
    """
